...
- Widget configuration stored in a hidden `workspace` document library in that site.
- Add, remove, resize, reorder, and configure operations restricted to SharePoint edit mode and users with `ManageWeb`.
...
4. Review and approve the API permissions required by your test plan.
5. Create or edit a modern SharePoint page.
6. Add **Workspace In Abox**, **My WorkSpace**, or both webparts.
7. Publish the page and test with a site manager and an ordinary user.
...
Approve only the permissions required by the widgets in your test plan and according to your organization's security and consent policies. See the [complete permission table](docs/INSTALLATION.md#3-review-and-approve-api-access).
